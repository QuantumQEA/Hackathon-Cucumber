...
@When("click on View plans and navigate to the plans page and required data")
public void click_on_view_plans_and_navigate_to_the_plans_page_and_required_data() {
	mobileNumberobject=new MobileNumber(BaseClass.getDriver());
	mobileNumberobject.viewplans();
}

@Then("display three lowest international  travel insurance plan")
public void display_three_lowest_international_travel_insurance_plan() {
